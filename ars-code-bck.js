...
// function clearData() {
//   var thiSheet = SpreadsheetApp.getActiveSpreadsheet();
//   var desTab = thiSheet.getSheetByName('RD');
//   desTab.getRange(1, 1, desTab.getMaxRows(), 13).clear();
// }

// function clearScheduleSV() {
//   var thiSheet = SpreadsheetApp.getActiveSpreadsheet();
//   var desTab = thiSheet.getSheetByName('Schedules SV');
//   desTab.getRange(1, 1, desTab.getMaxRows(), 39).clear();
// }

// function clearDistributionSV() {
//   var thiSheet = SpreadsheetApp.getActiveSpreadsheet();
//   var desTab = thiSheet.getSheetByName('Schedules SV');
//   desTab.getRange(1, 42, desTab.getMaxRows(), 33).clear();
// }